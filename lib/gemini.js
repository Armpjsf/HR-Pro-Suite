...
export async function generateResponse(message, user) {
  ...
  // คำถามที่ต้อง "เรียบเรียง/สรุป/เปรียบเทียบ" ควรใช้ Gemini แม้เจอชิ้นตรง
  const needsSynthesis = /สรุป|เปรียบเทียบ|ต่างกัน|แตกต่าง|ทำไม|เพราะอะไร|แนะนำ|ควรทำ|อธิบาย|ยังไง|อย่างไร/.test(message);
