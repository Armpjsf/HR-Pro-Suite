...
export const HR_MENUS = [
  ...
  { key: 'branches', href: '/hr/branches', icon: '🏬', label: 'สาขา' },
  ...
  { key: 'documents', href: '/admin/documents', icon: '📄', label: 'เอกสาร HR' },
  ...
  { key: 'users', href: '/admin/users', icon: '🛡️', label: 'จัดการผู้ใช้' },
